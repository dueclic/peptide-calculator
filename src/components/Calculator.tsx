...
const Calculator: React.FC = () => {
    ...
    return (
        <div className="calculator">
            ...
            <div ref={progressBarEl} className={`bg-no-repeat bg-contain border-0 w-full h-[60px] bg-white ${!submitted && 'invisible'}`}
                 style={{
                     backgroundImage: `url('${process.env.PUBLIC_URL}/images/30ml-04.png')`
                 }}>
                <div id="my-progress" className={"bar border-0 bg-alkemya-500 bg-opacity-50 h-full"} style={{

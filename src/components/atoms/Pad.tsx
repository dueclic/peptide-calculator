...
export const Pad: React.FC<PadProps> = ({onClick, selected, text, image}) => {
    ...
    const standardClassName = `flex flex-col justify-between items-center w-32 h-32 md:h-44 md:w-44 cursor-pointer rounded-md border-2 border-yellow-500 bg-black text-yellow-500
    transition-colors duration-300 ease-in-out text-lg hover:bg-gray-800 hover:text-yellow-500`;

    const selectedClassName = `flex flex-col justify-between items-center w-32 h-32 md:h-44 md:w-44 cursor-pointer rounded-md border-2 border-yellow-500 bg-yellow-500 text-black
